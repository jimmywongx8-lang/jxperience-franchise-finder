...
# --- CONTENT HELPERS (Simplified for Phase 3) ---
def get_brand(brand):
    return FRANCHISES.get(brand, {})

def get_about():
    return """### A Personal Journey with Japanese Culture
