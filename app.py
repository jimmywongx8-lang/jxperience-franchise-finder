...
# --- DISPLAY BRAND CARDS WITH VIEW BUTTONS ---
...
with st.form("contact_form"):
    ...
    brand_list = filtered_df['brand_name'].tolist()
    default_index = brand_list.index(default_brand) if default_brand in brand_list else 0
    selected_brand = st.selectbox("Which brand interests you?", brand_list, index=default_index)
